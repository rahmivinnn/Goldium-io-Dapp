      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="border-gold bg-black hover:gold-glow transition-all duration-300">
          <CardContent className="p-0">
            <div className="relative h-40">
              <Image
                src="/placeholder.svg?height=300&width=600&query=fantasy card battle game"
                alt="Card Battle"
                fill
        ...
        <Card className="border-gold bg-black hover:gold-glow transition-all duration-300">
          <CardContent className="p-0">
            <div className="relative h-40">
              <Image
                src="/placeholder.svg?height=300&width=600&query=gold coin flip game"
                alt="Coin Flip"
                fill
                className="object-cover rounded-t-lg"
              />
        ...
        <Card className="border-gold bg-black hover:gold-glow transition-all duration-300">
          <CardContent className="p-0">
            <div className="relative h-40">
              <Image
                src="/placeholder.svg?height=300&width=600&query=fantasy card flip memory game"
                alt="Card Flip"
                fill
                className="object-cover rounded-t-lg"
              />
