...
import FloatingParticles from "@/components/floating-particles" // Fixed import
    ...
    <main className="flex min-h-screen flex-col items-center justify-between relative overflow-hidden">
      ...
      <div className="w-full min-h-screen flex flex-col items-center justify-center px-4 relative z-10">
        ...
        <div className="mt-12 w-full max-w-xl">
          <div className="bg-black/30 backdrop-blur-sm border border-yellow-500/30 rounded-lg p-4 flex items-center justify-between">
            <span className="text-white font-mono">GOLD Token CA: {contractAddress}</span>
